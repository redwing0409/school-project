...
<html lang="">
	...
	<body>
		<nav class="navbar navbar-default" role="navigation">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<div class="col-xs-12 col-sm-4 pull-left">
						<img src="<%=request.getContextPath()%>/supplier_end/ord/logo/MarryMe-logo.png" id="logo">
						<img src="<%=request.getContextPath()%>/supplier_end/ord/logo/MarryMe-Word.png" id="logo-word">
				</div>
				<!-- 左導覽結束 -->
				<!-- 右導覽 -->
		        ...
		        <form METHOD="post" ACTION="<%=request.getContextPath()%>/ord/ord.do">
		            ...
		            <div class="col-xs-12 col-sm-5">
		            	<div class="input-append date">
					        <label class="col-sm-3 control-label">商品編號</label>
					        <div class="col-sm-4 pull-left">	           
					            <input type="text" class="form-control" name="com_no" placeholder="請點選"></input>
					        </div>
				        </div>
		            </div>
		            <div class="col-xs-12 col-sm-2">
        ...
        <div class="row">
      		<%if (request.getAttribute("listOrderItem_ByCompositeQuery")!=null){%>
     		 <jsp:include page="/supplier_end/ord/listOrdItem_ByCompositeQuery.jsp" flush="true"/>
			<%}%> 
			
			<%if (request.getAttribute("ordVO")!=null) {%>
			  <jsp:include page="/supplier_end/ord/update_ord_input.jsp" flush="true"/>
			<%}%>
			
			<%if (request.getAttribute("ordVO2")!=null) {%>
			  <jsp:include page="/supplier_end/ord/listOneOrd.jsp" flush="true"/>
			<%}%>
