...
<table  table class="table table-hover table-striped table-bordered table-condensed" color="lightblue" style="width:80%">
	...
	<tr align='center' valign='middle'>
		<td>${updateSupVO1.sup_acct}</td>
		<td>${updateSupVO1.sup_id}</td>
		<td>${updateSupVO1.sup_con}</td>
		<td>${updateSupVO1.sup_telcode}</td>
		<td>${updateSupVO1.sup_tel}</td>	
		<td>${updateSupVO1.sup_tax}</td>
		<td>${updateSupVO1.sup_adcode}</td>
		<td>${updateSupVO1.sup_addr}</td>
	</tr>
</table>
</body>
</html>
