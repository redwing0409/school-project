...
<%
	SupVO SupVO = (SupVO) request.getAttribute("SupVO"); //SupServlet.java (Concroller), 存入req的SupVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
<html>
<head>
<title>廠商認證 - update_sup_input.jsp</title>
<meta charset="big5">
...
<%-- 						<td><%=SupVO.getSup_type()%></td> --%>
				...
				<input type="submit" class="btn btn-success" value="通過審核">
			    </FORM>
			    </td>
			    </tr>
			    </table>
