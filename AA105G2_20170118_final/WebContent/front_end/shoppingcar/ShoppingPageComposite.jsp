...
<%
List<ComVO> list2 = (List<ComVO>) session.getAttribute("CompositeQuery_front");
...
<html lang="">
	<head>
		...
		<link rel="stylesheet" href="<%=request.getContextPath()%>/front_end/css/ShoppingPageComposite.css">
		        ...
		        <div class="col-xs-12 col-sm-10">
		        	...
		        	<c:forEach var="comVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		        	     <div class="col-xs-12 col-sm-4">
						    ...
						    <div id="demo"><a href="<%=request.getContextPath()%>/com/com.do?action=getOne_For_Display&com_no=${comVO.com_no}&number=1">
