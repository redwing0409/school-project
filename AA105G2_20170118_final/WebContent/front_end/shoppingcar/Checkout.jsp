...
<html lang="">
	<head>
		...
		<link rel="stylesheet" href="<%=request.getContextPath()%>/front_end/css/Checkout.css">
	...
	<!-- 	 <style>
	        ...
	        #type td {text-align: center; border:#fff solid 1px}
	        #type th {background-color: #FF60AF; color:white;border:#fff solid 1px; text-align:center;}
	        .odd{background-color: #f2cde0;}
	        .even{background-color:#f8e6ef;}
    	</style> -->
...
<!-- 修改會員資料結束 -->
	<div id="websocketArea">
		...
		<!-- 這邊是大家頁面內容 -->
 			<div id="bgpanel">
	 			<div id="shoppingcar" style="float:right;padding:200px;margin-top:-180px;margin-right:100px">
					 <h4 style="margin-left:170px;font-weight:bold">訂單明細</h4> 
                     <table id="type" style="width:auto;text-align:center;" class="table table-hover table-striped table-bordered table-condensed" color="lightblue" >
							<th width="200"  style="text-align:center">商品名稱</th>
							<th width="100"  style="text-align:center">商品價格</th>
				      ...
				      <%
		 		      ...
		 		      <%
				        for(int i=0;i<buylist.size();i++) {
				        	...
				        	String com_no = ordlist.getCom_no();
				        	Integer ord_price = ordlist.getOrd_price();
				        	Integer ordcom_qty = ordlist.getOrd_qty();
		 		      %>
						 <tr width="720">
								<td width="200"><div align="center"><b><%=comSvc.getOneCom(com_no).getCom_name()%></b></div></td>
								<td width="100"><div align="center"><b>$<%=ord_price%></b></div></td>
								<td width="100"><div align="center"><b><%=ordcom_qty%>件</b></div></td>
						  </tr>
	 		      	  <%
					     }
				 	  %>
					  	<tr>					
							...
							<td colspan="2"> <font><b>$<%=amount%></b></font> </td>
						</tr>
				  	</table>
					     <div id="shoplink" style="margin-top:-15px">
						  		<div><a href="<%=request.getContextPath()%>/front_end/shoppingcar/ShoppingPage.jsp"><input type="submit" value="繼續購物"></a>
						  		<a href="<%=request.getContextPath()%>/front_end/shoppingcar/TransmitInfo.jsp"><input type="submit" value="下一步"></a></div>
				 		</div> 
				 </div>
