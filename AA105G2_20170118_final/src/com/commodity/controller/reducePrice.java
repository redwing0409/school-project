...
@ServerEndpoint("/commodity/reducePrice")
public class reducePrice {
private static final Set<Session> allSessions = Collections.synchronizedSet(new HashSet<Session>());
    
    @OnOpen
    public void onOpen(@PathParam("member_no") String member, Session priceSession) throws IOException{
    	allSessions.add(priceSession);
    	System.out.println(priceSession.getId());
