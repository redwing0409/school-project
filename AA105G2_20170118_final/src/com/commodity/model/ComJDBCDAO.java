...
import com.purchase_order.model.PurVO;
...
public class ComJDBCDAO implements ComDAO_interface {
    ...
    public static void main(String[] args) throws  Throwable{
    	...
    	// 新增
  	    File pic = new File("images/picFrom", "漂亮.jpg");
		InputStream fin = new FileInputStream(pic);
		byte[] buffer = new byte[fin.available()];
		fin.read(buffer);
		ComVO comVO1 = new ComVO();
		comVO1.setSup_no("6002");
		comVO1.setPcm_no(2);
		comVO1.setCom_name("喜帖我愛你");
		comVO1.setCom_desc("喜帖我愛你");
		comVO1.setCom_price(30);
		comVO1.setCom_status(9);
		...
		comVO1.setCom_pic(buffer);
		dao.insert(comVO1);
        fin.close();
    	
    
    	//修改
//      File pic = new File("images/picFrom", "2835-2.gif");
//		InputStream fin = new FileInputStream(pic);
//		byte[] buffer = new byte[fin.available()];
//		fin.read(buffer);
//    	ComVO comVO2 = new ComVO();
//    	comVO2.setCom_no("10027");
//    	comVO2.setSup_no("10001");
//    	comVO2.setPcm_no(9);
//    	comVO2.setCom_name("喜帖9453");
//		comVO2.setCom_desc("愛你一萬年");
...
//     	dao.delete("10012");
    	...
    	// 查詢單筆資料
//		ComVO comVO3 = dao.findByPrimaryKey("10010");	
//		File file = new File("images/picReaded", comVO3.getCom_pic()+"."+"jpg");
//		OutputStream out = new FileOutputStream(file);  
// 		out.write(comVO3.getCom_pic(),0,comVO3.getCom_pic().length);
//  
...
//		System.out.println("------------------------");
    	...
    	//查詢全部
	    	...
	    	File file = new File("images/picReaded", aCom.getCom_pic() + "." +"png");
			OutputStream out = new FileOutputStream(file);
			out.write(aCom.getCom_pic(), 0, aCom.getCom_pic().length);
